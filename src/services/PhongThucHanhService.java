...
public class PhongThucHanhService {
    ...
    public OperationResult createPhongThucHanh(String tenPhong, String loaiPhong, String diaDiem, int sucChua, String tinhTrang) {
        // Kiểm tra trống
        if (tenPhong.isBlank() || loaiPhong.isBlank() || diaDiem.isBlank()) {
            return OperationResult.ADD_FAILURE;
        } else {
            PhongThucHanh phongThucHanh = new PhongThucHanh(null, tenPhong, loaiPhong, diaDiem, sucChua, tinhTrang);
