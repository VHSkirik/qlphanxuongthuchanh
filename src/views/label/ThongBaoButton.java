 ...
 * @author @VHSkirik
 */
public class ThongBaoButton extends JButton {
    
    private BufferedImage img;
    private Color badgeColor = new Color(220, 67, 67);
    
    public ThongBaoButton() {
    ...
    private void createImage() {
        if (getIcon() != null) {
            img = new BufferedImage(getIcon().getIconWidth(), getIcon().getIconHeight(), BufferedImage.TYPE_INT_ARGB);
    ...
    private class BadgeButtonUI extends BasicButtonUI {
        ...
        protected void paintIcon(Graphics g, JComponent c, Rectangle iconRect) {
            if (img != null && !getText().equals("")) {
                ...
                g2.setPaint(new TexturePaint(img, iconRect));
                g2.fill(area);
                String text = getText();
