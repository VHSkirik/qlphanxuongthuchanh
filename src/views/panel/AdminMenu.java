...
public class AdminMenu extends javax.swing.JPanel {
    ...
    private void myInit() {
        listMenu1.addItem(new Model_Menu("", "Admin", Model_Menu.MenuType.TITLE));
        listMenu1.addItem(new Model_Menu("1", "DashBroad", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("2", "Phòng", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("3", "Thiết Bị", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("multi_user", "Người Dùng", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("gv3", "Yêu Cầu", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("feedback", "Phản Hồi", Model_Menu.MenuType.MENU));
